...
const UEMOA_ASSETS: AssetClass[] = ['savings_account', 'term_deposit', 'government_bonds', 'local_stocks', 'tontine', 'money_market', 'mutual_fund', 'municipal_bonds', 'agrobusiness', 'esg_bonds'];
const CEMAC_ASSETS: AssetClass[] = ['savings_account', 'term_deposit', 'government_bonds', 'real_estate_fund', 'money_market', 'municipal_bonds', 'agrobusiness', 'mining_assets'];
const DEV_ASSETS: AssetClass[] = ['savings_account', 'term_deposit', 'government_bonds', 'corporate_bonds', 'stock_index', 'real_estate_fund', 'gold', 'money_market', 'mutual_fund', 'private_equity', 'infrastructure', 'esg_bonds', 'commodities'];
const ISLAMIC_ASSETS: AssetClass[] = ['savings_account', 'term_deposit', 'sukuk', 'gold', 'real_estate_fund', 'mutual_fund', 'esg_bonds', 'infrastructure'];
...
export const COUNTRY_RISK_PROFILES: Record<string, CountryRiskProfile> = {
  ...
  'KE': { code: 'KE', name: 'Kenya', rho: 0.45, countryFactor: 1.10, wbClass: 'lower_middle', currency: 'KES', inflationAvg5y: 7.5, investmentInfraLevel: 2, shariaRelevant: true, localBenchmarkReturn: 10, savingsAccountRate: 6, currencyVolatility: 'medium', availableAssets: ['savings_account', 'term_deposit', 'government_bonds', 'local_stocks', 'money_market', 'mutual_fund', 'real_estate_fund', 'esg_bonds', 'agrobusiness', 'venture_capital', 'carbon_credits', 'tokenized_assets'], taxAdvantageAccounts: [] },
  'ZA': { code: 'ZA', name: 'Afrique du Sud', rho: 0.35, countryFactor: 1.02, wbClass: 'upper_middle', currency: 'ZAR', inflationAvg5y: 5.5, investmentInfraLevel: 1, shariaRelevant: false, localBenchmarkReturn: 10, savingsAccountRate: 5, currencyVolatility: 'medium', availableAssets: [...DEV_ASSETS, 'local_stocks', 'venture_capital', 'mining_assets', 'mezzanine', 'carbon_credits'], taxAdvantageAccounts: ['TFSA'] },
  ...
  // --- Amériques ---
  'US': { code: 'US', name: 'États-Unis', rho: 0.20, countryFactor: 0.88, wbClass: 'high', currency: 'USD', inflationAvg5y: 4.0, investmentInfraLevel: 1, shariaRelevant: false, localBenchmarkReturn: 10, savingsAccountRate: 4.5, currencyVolatility: 'low', availableAssets: [...DEV_ASSETS, 'crypto', 'venture_capital', 'venture_debt', 'mezzanine', 'derivatives', 'carbon_credits', 'tokenized_assets'], taxAdvantageAccounts: ['401k', 'Roth IRA', 'HSA'] },
