...
interface Page14PriorityActionsN1Props {
  calculated: CalculatedFields;
  selectedCurrency: Currency;
  businessLines: BusinessLine[];
}

export function Page14PriorityActionsN1({
  calculated,
  selectedCurrency,
  businessLines
}: Page14PriorityActionsN1Props) {
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-gray-900/70 rounded-lg mb-6 text-center border border-gray-700">
        <h3 className="text-lg font-bold text-white">
          14 - PRIORITY ACTIONS - N+1 / Action plan or progress plan by key areas of socio-economic improvement
        </h3>
        <p className="text-sm text-gray-400 mt-2">
          Distribution des objectifs d'économie de coûts pour l'année N+1 par ligne d'activité et par indicateur de performance
        </p>
      </div>

      {/* Calendrier Fiscal - Contexte temporel N+1 */}
      <FiscalCalendarWidget
        selectedPeriod={{ year: new Date().getFullYear() + 1, quarter: 1 }}
        title="Calendrier N+1 - Trimestre 1"
        compact
        className="mb-6"
      />
              ...
              <div className="space-y-2 text-sm text-red-200">
                {pprN1 <= 0 && (
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <strong>PPR de l'année N+1 manquant ou nul (actuellement: {formatCurrency(pprN1, selectedCurrency)})</strong>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="bg-gray-800/50 rounded-lg p-4 text-center border border-gray-700">
          <div className="text-sm font-bold text-gray-300 mb-1">PPR de l'année N+1</div>
          <div className="text-2xl font-bold text-green-400">{formatCurrency(pprN1, selectedCurrency)}</div>
      ...
      <div className="bg-blue-900/20 border border-blue-700/40 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-200">
            <strong>Note:</strong> Les objectifs d'économie de coûts sont distribués selon la pondération
              ...
              <React.Fragment key={quarter}>
                ...
                <div className="bg-blue-900/20 border border-blue-700/40 rounded-lg p-4 mt-6 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-blue-200">
                      <strong>Trimestre {quarter}:</strong> Les objectifs trimestriels représentent 25% du PPR annuel N+1.
