...
interface Page15PriorityActionsN2Props {
  calculated: CalculatedFields;
  selectedCurrency: Currency;
  businessLines: BusinessLine[];
}

export function Page15PriorityActionsN2({
  calculated,
  selectedCurrency,
  businessLines
}: Page15PriorityActionsN2Props) {
  ...
  // Formules Excel identiques à Page 14, sauf C13 = gainsN2 au lieu de gainsN1
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-gray-900/70 rounded-lg mb-6 text-center border border-gray-700">
        <h3 className="text-lg font-bold text-white">
          15 - PRIORITY ACTIONS - N+2 / Action plan or progress plan by key areas of socio-economic improvement
        </h3>
        <p className="text-sm text-gray-400 mt-2">
          Distribution des objectifs d'économie de coûts pour l'année N+2 par ligne d'activité et par indicateur de performance
        </p>
      </div>

      {/* Calendrier Fiscal - Contexte temporel N+2 */}
      <FiscalCalendarWidget
        selectedPeriod={{ year: new Date().getFullYear() + 2, quarter: 1 }}
        title="Calendrier N+2 - Trimestre 1"
        compact
        className="mb-6"
      />
              ...
              <div className="space-y-2 text-sm text-red-200">
                {pprN2 <= 0 && (
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <strong>PPR de l'année N+2 manquant ou nul (actuellement: {formatCurrency(pprN2, selectedCurrency)})</strong>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="bg-gray-800/50 rounded-lg p-4 text-center border border-gray-700">
          <div className="text-sm font-bold text-gray-300 mb-1">PPR de l'année N+2</div>
          <div className="text-2xl font-bold text-green-400">{formatCurrency(pprN2, selectedCurrency)}</div>
      ...
      <div className="bg-blue-900/20 border border-blue-700/40 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-blue-200">
            <strong>Note:</strong> Les objectifs d'économie de coûts pour l'année N+2 sont distribués selon la pondération
              ...
              <React.Fragment key={quarter}>
                ...
                <div className="bg-blue-900/20 border border-blue-700/40 rounded-lg p-4 mt-6 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-blue-200">
                      <strong>Trimestre {quarter}:</strong> Les objectifs trimestriels représentent 25% du PPR annuel N+2.
