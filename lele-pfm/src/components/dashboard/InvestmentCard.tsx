...
export function InvestmentCard() {
    ...
    return (
        <View className="px-6 mb-6">
            <H3 className="text-xs uppercase text-gray-400 tracking-wider mb-4">Performance financière</H3>
            <GlassCard variant="dark" className="p-0 overflow-hidden">
                ...
                >
                    <View className="flex-row items-center gap-4">
                        ...
                        <View>
                            <Text className="text-white font-bold text-lg">Score global</Text>
                    ...
                    <View className="items-end">
                        ...
                        <View>
                            ...
                            {!hasData && (
                                <Text className="text-white/40 text-xs text-right">Complétez le wizard</Text>
                            )}
                            {hasData && gradeInfo && (
